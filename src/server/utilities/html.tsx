...
export const getHtmlHead = (serverSideCss: string) =>
  `<!DOCTYPE html><html><head><title>POWR</title>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1"><style>${getCssReset()}</style><style id="jss-server-side">${serverSideCss}</style></head><body><div id='root'>`;
